        ...
        <div class="checkout-order">
            ...
            <div class="item-list-wrap confirm-item-list-wrap">
                <div class="cart-item order-item">
                    ...
                    <ul class="cart-item-list">
                        <li v-for="(item, index) in cartListChecked">
            ...
            <div class="order-foot-wrap">
                <div class="prev-btn-wrap">
                    <router-link to="/address" class="btn btn--m" >返回上一页</router-link>
                </div>
...
export default {
    ...
    computed:{
        ...
        subtotal: function (){
            let subtotal = 0;
            this.cartListChecked.forEach(function (item, index){
    ...
    methods: {
        ...
        payment: function (){            
            ...
            axios.post('/api/users/order/add',postData).then((res) => {
                //    console.log(res)
                if(res.data.status == 200){
                   console.log(res)
                   this.$router.push({
