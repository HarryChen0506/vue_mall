                    ...
                    <ul class="cart-item-list">
                        <li v-for="item in cartList">
                            ...
                            <div class="cart-item-check">
                                <a  class="checkbox-btn item-check-btn" v-bind:class="{'check':item.checked=='1'}" @click="editCart(item,'checked')">
...
export default {
    ...
    computed:{
        ...
        checkAllFlag: function (){
            return this.cartList.length == this.checkAllCount;
        },
    ...
    methods: {
        ...
        checkAll: function (){
            ...
            axios.post('/api/users/cart/checkAll',{             
                checkAll: flag                  
            }).then((res) => {
                //    console.log(res)
                if(res.data.status == 200){
