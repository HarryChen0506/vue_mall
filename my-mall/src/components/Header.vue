<template>
    <header class="header">
        ...
        <div class="md-modal modal-msg md-modal-transition" v-bind:class="{'md-show':loginModal_flag}">
          <div class="md-modal-inner">
                <div class="md-top">
                    <div class="md-title">Login in</div>
                    <button class="md-close" @click="loginModal_flag=false">Close</button>
                </div>
        ...
        <div class="md-overlay" v-if="loginModal_flag" @click="closeLoginModal()"></div>
    </header>
</template>
